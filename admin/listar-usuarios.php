...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <div class="row">
            <div class="col-md-9">
                <h6 class="m-0 font-weight-bold text-info">Lista de Usuários</h6>
            </div>
            <div class="col-md-3">
                <a href="cadastrar-usuarios.php">
                    <button class="btn btn-info col-md-12">+ Nova usuário</button>
                </a>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered"  id="table-usuarios" widht="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    $id = $_SESSION['id'];
                    $sql = "SELECT * FROM usuario WHERE id = $id ORDER BY id DESC";
